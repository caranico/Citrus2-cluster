...
class CssUrlPath implements FilterInterface  
{
    ...
    public function __construct( $basePath, $baseRedir = false )
    {
        $this->baseRedir = $baseRedir;
    ...
    {
        $pathCss = '/' . ($this->baseRedir ? $this->baseRedir : 'asset') . array_pop( explode($this->basePath, $asset->getSourceRoot())) . '/';
